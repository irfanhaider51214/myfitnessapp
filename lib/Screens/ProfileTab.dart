...
List<Quotes> quotes = [
  new Quotes("GET LiTT ", "See who likes you & more!"),
  ...
  new Quotes("Increase your chances", "Get unlimited likes with LiTT Plus!"),
  new Quotes(
      "Swipe around the world!", "Passport to anywhere with LiTT Plus!"),
];
